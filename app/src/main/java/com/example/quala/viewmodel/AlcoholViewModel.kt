...
class AlcoholViewModel: ViewModel() {
    ...
    fun requestConditionalAlcohol(condition: AlcoholConditionalRequest) {
        QualaAPI.requestConditionalAlcohol(condition).enqueue(object : Callback<AlcoholConditionalResponse> {
